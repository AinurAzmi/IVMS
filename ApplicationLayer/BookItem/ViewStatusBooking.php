...
?>
			<?php
                while($row = mysqli_fetch_array($retrive))
                {
					...
					<td><a title="Edit" href="controller.php?action=edit&id='.$row->BookingID.'" class="btn btn-danger btn-xs" >Edit</a>
						<a title="Delete" href="controller.php?action=delete&id='.$row->BookingID.'" class="btn btn-danger btn-xs" >Delete</a>
				  					 </td>';
                    </tr>
                <?php
                }
