...
<head>
	...
	body 
	{
		<div class="wrapper">
		<div class="header">
		<p>Search Box by ID and Date</p>
</div>

<div class="container">
		<div class="search_id search_date">
		<div class="search">
		<input type ="text" class"input placeholder="Search by Date ">
		</div>

		<div class="container">
		<div class="search_id search_ID">
		<div class="search">
		<input type ="text" class"input placeholder="Search by ID ">
		</div>
	}
	{
  margin: 0;
